const {Financial} = require('../models/financial.js'); // Ajuste conforme necessário
const {BankAccount} = require('../models/financial.js'); // Ajuste conforme necessário
const { Bill } = require('../models/financial.js'); // Ajuste conforme necessário
